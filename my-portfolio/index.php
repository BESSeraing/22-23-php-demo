        ...
        echo ' <!-- Portfolio Item 1-->
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/'.$realisation['image'].'" alt="..." />
                            <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">'.$realisation['title'].'</h2>
                        </div>
                    </div>';
    }
